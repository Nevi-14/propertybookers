...
<html>
 ...
 <link rel="stylesheet" href="{{asset('css/clean-switch.css')}}">
        ...
        <body class="hold-transition text-sm sidebar-mini layout-fixed layout-navbar-fixed sidebar-collapse">
        <div class="wrapper">
            ...
            <footer class="main-footer">
                <strong>{{__('Copyright')}} &copy;
                    ...
                    <b>{{__('Version 1.5.1')}}</b>

                    </div>
            </footer>

            <aside class="control-sidebar control-sidebar-dark layout-fixed layout-navbar-fixed">
