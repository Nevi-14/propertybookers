                    ...
                    <tbody>
                        @foreach (@$estimates as $estimate)
                            ...
                            <td>
                                ...
                                <br>
                                <div class="d-hide mt-1" id="extraButtons{{@$estimate->id}}">
                                  <a class="btn btn-sm btn-primary text-bold font13 pr-2" href="#" data-toggle="modal" data-target="#viewestimate{{@$estimate->id}}">
                                    {{__('View')}}
                                  </a>
                                  <a class="btn btn-sm btn-primary text-bold font13 pr-2 mt-1" href="{{url('estimate/estimate_pdf', @$estimate)}}" target="_blank">
                                    {{__('PDF')}}
                                  </a>
                                  <br>
                                  <a href="{{url('estimate/email/'.@$estimate->id )}}" id="email_sending" class="btn btn-sm btn-primary text-bold pr-2 mt-1"> 
                                    {{__('Email')}}
