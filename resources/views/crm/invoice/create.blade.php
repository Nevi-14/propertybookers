                ...
                <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                          ...
                          <input type="text" name="invoice_number" value="{{old('invoice_number')}}" class="form-control form-control-sm" required/>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                          <label for=""><span class="text-danger">*</span> {{__('Invoice Title')}} </label>
                          <input type="text" name="invoice_title" value="{{old('invoice_title')}}" class="form-control form-control-sm" required/>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
