                        ...
                        @foreach (@$invoices as $invoice)
                            <tr {!! $extraButtons[$invoice->id] !!}>
                              ...
                              <td>
                                ...
                                <div class="d-hide mt-1" id="extraButtons{{@$invoice->id}}">
                                  <a class="btn btn-sm btn-primary text-bold font13 pr-2 mt-1" href="#" data-toggle="modal" data-target="#viewInvoice{{@$invoice->id}}">
                                    {{__('View')}}
                                  </a>
                                  <a class="btn btn-sm btn-primary text-bold font13 pr-2 mt-1" href="{{url('invoice/invoice_pdf', $invoice)}}" target="_blank">
                                    {{__('PDF')}}
                                  </a>
                                  <a href="{{url('invoice/email/'.$invoice->id )}}" id="email_sending" class="btn btn-sm btn-primary text-bold mt-1"> 
                                    {{__('Email')}}
