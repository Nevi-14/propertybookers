<div class="card stage">
    <div class="card-header" id="headingOne">
        <div class="row">
            <div class="col-8 d-flex align-items-center">
                <h3 class="mb-0 text-bold text-secondary ">
                    <i class="fas fa-angle-double-right  mr-1"></i> FOLLOW-UPS
                </h3>
            ...
            <button class="btn btn-link  text-success  float-right" type="button" data-toggle="collapse" data-target="#follow-ups" aria-expanded="true" aria-controls="follow-ups">
            <h4><span class="badge badge-info">{{$propertyTracker->appointment->where('type', 'follow-up')->count()}} </span></h4>
                </button>
    ...
    <div id="follow-ups" class="collapse " aria-labelledby="headingOne" data-parent="#accordionExample">
        <div class="card-body">
