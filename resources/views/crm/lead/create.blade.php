              ...
              <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="first_name" class="form-control form-control-sm " placeholder="{{__('Enter leads First Name')}}" 
                        />
                    </div>
                    <span class="text text-danger"></span>
                </div>
                <div class="col-md-4 col-sm-12">
                  <div class="form-group">
                      ...
                      <input type="text" name="last_name" class="form-control form-control-sm " placeholder="{{__('Enter leads Last Name')}}" data-validation="length" data-validation-length="2-20" required 
                      />
                  </div>
                ...
                <div class="col-md-12 col-sm-12">
                  <div class="form-group">
                      ...
                      <input type="text" name="company_name" class="form-control form-control-sm " placeholder="{{__('Enter Leads Company Name')}}" 
                      />
                  </div>
                  <span class="text text-danger"></span>
                </div>
              ...
              <div class="row mt-2">
                ...
                <div class="col-md-4 col-sm-12">
                  <span ><span class="text-danger"></span>  {{__('Email')}}
                    ...
                    <div class="input-group">
                        <input type="text" name="email" class="form-control form-control-sm " placeholder="Enter leads Email" id="email" >
                    </div>
                ...
                <div class="col-md-4 col-sm-12">
                  <span ><span class="text-danger"></span>  {{__('Phone')}}
                    ...
                    <div class="input-group">
                        <input type="text" name="phone" class="form-control form-control-sm " placeholder="{{__('Enter leads Phone')}}" />
                        <span class="text text-danger"></span>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-12">
                  <span ><span class="text-danger"></span> {{__('Fax')}}
                    ...
                    <div class="input-group">
                        <input type="text" name="fax" class="form-control form-control-sm " placeholder="{{__('Enter leads Fax')}}" />
                        <span class="text text-danger"></span>
                    </div>
                </div>                
              ...
              <div class="row mt-3">  
                ...
                <div class="col-md-4 col-sm-12">
                  <div class="form-group">
                      ...
                      <i class="fas fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('Format: CountryCode PhoneNumber, dont use + symbol (CCXXXXXXXXXX)')}}"></i>
                    </span>
                ...
                <div class="col-md-8 col-sm-12">  
                  <span>{{__('Notes')}}</span>
                  <div class="input-group">
                    <textarea class="form-control form-control-sm" rows="5" name="note" placeholder="{{__('Notes Here')}}"></textarea>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-5 col-sm-12">
                      <div class="form-group">
                          ...
                          <div class="input-group">
                              <input type="tel" name="phone_1" class="form-control form-control-sm " />
                          </div>
                      </div>
                      <div class="form-group">
                          <span> {{__('Phone 2')}} </span> 
                          <div class="input-group">
                              <input type="tel" name="phone_2" class="form-control form-control-sm " />
                          </div>
                      </div>
                      <div class="form-group">
                          <span> {{__('Email 1')}} </span> 
                          <div class="input-group">
                              <input type="email" name="email_1" class="form-control form-control-sm " />
                          </div>
                      </div>
                      <div class="form-group">
                          <span> {{__('Email 2')}} </span> 
                          <div class="form-group">
                              <input type="email" name="email_2" class="form-control form-control-sm "  />
                          </div>
                      </div>
                      <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="patreon" class="form-control form-control-sm "  />
                    </div>
                  </div>
