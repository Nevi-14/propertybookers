                        ...
                        @foreach (@$proposals as $proposal)
                            <tr {!! $extraButtons[$proposal->id] !!}>
                              ...
                              <td>
                                ...
                                <br>
                                <div class="d-hide mt-1" id="extraButtons{{@$proposal->id}}">
                                  <a class="btn btn-sm btn-primary text-bold font13 pr-2 mt-1" href="#" data-toggle="modal" data-target="#viewProposal{{@$proposal->id}}">
                                    {{__('View')}}
                                  </a>
                                  <a class="btn btn-sm btn-primary text-bold font13 pr-2  mt-1" href="{{url('proposal/proposal_pdf', $proposal)}}" target="_blank">
                                    {{__('PDF')}}
                                  </a>
                                  <a href="{{url('proposal/email/'.$proposal->id )}}" id="email_sending" class="btn btn-sm btn-primary text-bold  mt-1"> 
                                    {{__('Email')}}
                                    <span class=" d-hide"  id="show_email_loader">
