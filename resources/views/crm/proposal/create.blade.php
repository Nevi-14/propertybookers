                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select name="relation" id="relation" class="select form-control form-control-sm" data-validation="required" required>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select name="lead_customer_id" id="lead_customer_id" class="select form-control form-control-sm" required data-validation="required">
                      </select>
                    </div>
                  </div>
                  <div class="col-md-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select name="currency_id" class="select form-control form-control-sm">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select name="assigned_to" class="select form-control form-control-sm" required>
                    ...
                    <div class="row">
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <select id="product_id" class="select form-control form-control-sm">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="input-group">
                          <input type="number" class="form-control form-control-sm" placeholder="{{__('Amount')}}" id="product_amount" step="0.02" readonly />
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <select name="discount_type" id="discount_type"  class="select form-control form-control-sm">
                        @php
                          $discount_types = [
                            __('Before Tax'), 
                            __('After Tax')
