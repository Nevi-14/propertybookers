										...
										<div class="row">
											<div class="col-md-4">
													<div class="form-group">
															...
															<select name="relation"  class="select relation form-control form-control-sm"
																	required>
											...
											<div class="col-md-4">
													<div class="form-group">
															...
															<select name="lead_customer_id" id="lead_customer_id"
																	class="select form-control form-control-sm" required>
															</select>
													</div>
											</div>
											<div class="col-md-4">
													<div class="form-group">
															...
															<select name="owner_id" class="select form-control form-control-sm" required>
											...
											<div class="col-md-4">
												<div class="form-group">
														...
														<select name="priority" class="select form-control form-control-sm">
																@php
																$priorities = [
																	__('High'),
																	__('Med'),
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<select name="type" class="select form-control form-control-sm">
															@php
															$types = [
																__('Email'), 
																__('Call'), 
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<select name="status" class="select form-control form-control-sm">
															@php
															$statusess = [
																__('Waiting'),
																__('Started'), 
					...
					<div class="card-body">
							...
							<div class="row">
									<div class="col-md-4">
										<div class="form-group">
												<label>{{__('Type')}}</label>
												<select name="type" id='type{{$task->id}}' class="select form-control flex-fill">
														@php
															$types = [
																__('Email'), 
																__('Call'), 
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="">{{__('Status')}}</label>
										<select name="status" class="select form-control" id="status{{$task->id}}">
												@php
													$statusess = [
														__('Waiting'),
														__('Started'), 
								...
								<div class="col-md-4">
										<div class="form-group">
												<label for=""><span class="text-danger">*</span>{{__('Select Customer/Lead')}} </label>
												<select name="lead_customer_id" id="lead_customer_id_modal{{$task->id}}" class="select form-control form-control-sm" required>
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for=""><span class="text-danger">*</span> {{__('Task Owner')}}</label>
										<select name="owner_id" class="select form-control form-control-sm" required>
												@foreach ($task_owners as $user)
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<select name="repeat_every" class="select form-control form-control-sm">
															@php
																	$repeats = [
																		__('week'),
																		__('day'), 
