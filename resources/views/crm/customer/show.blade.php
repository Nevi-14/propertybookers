                      ...
                      <div class="card-body bg-light-gray">
                        ...
                        <div class="col-md-4 col-sm-12">
                          <div class="form-group">
                              ...
                              <i class="fas fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('whatsappnote1')}}"></i>
                              </span>
                              <input type="number" name="whatsapp" class="form-control form-control-sm " placeholder="{{__('Enter WhatsApp Number')}}" value="{{@$customer->first_contact->whatsapp}}" />
                          </div>
                          <span class="text text-danger"></span>
                        </div>
            ...
            <div class="card-body">
              ...
              <div class="col-md-4 col-sm-12">
                <div class="form-group">
                    ...
                    <input type="number" name="whatsapp" class="form-control form-control-sm " placeholder="{{__('Enter WhatsApp Number')}}" value="{{@$contact->whatsapp}}" />
                </div>
                <span class="text text-danger"></span>
              </div>
            ...
            <div class="card-body">
              ...
              <div class="col-md-4 col-sm-12">
                <div class="form-group">
                    ...
                    <input type="number" name="whatsapp" class="form-control form-control-sm " placeholder="{{__('Enter WhatsApp Number')}}" />
                </div>
                <span class="text text-danger"></span>
              </div>
