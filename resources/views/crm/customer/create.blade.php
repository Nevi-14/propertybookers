                    ...
                    <div class="row">
                      <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                          ...
                          <i class="fas fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{__('customer-tooltip1')}}"></i> 
                          <i class="fas fa-info-circle text-primary" data-toggle="tooltip" data-placement="top" title="{{__('customer-tooltip1')}}"></i>                    
                        </span>
