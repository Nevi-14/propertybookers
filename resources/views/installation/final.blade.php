...
<div class="container">
    <center><h4 class="text-light">DevPremier CRM Installation Wizard</h4></center>
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-md-12">
        ...
        <form action="{{url('install/final')}}" method="POST">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <textarea name="env" class="form-control bg-dark text-light" id="" cols="30" rows="7">{{$contents}}</textarea>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
