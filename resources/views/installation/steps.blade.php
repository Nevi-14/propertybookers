      ...
      @csrf
        ...
        <div class="panel panel-primary setup-content" id="step-4">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-12">
                  <p><b>Note: </b>Run this Cron Job in your server to send email, because this software will insert the email data in the (queue)database, and on running cron, it will automatically be sent to the user from the database jobs table.</p>
                  <strong>
