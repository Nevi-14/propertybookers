...
class LoginController extends Controller
{
    ...
    public function passwordReset($token){
        ...
        if($customer == null){
    // OLD        return view('client.auth.passwords.email')->withErrors(['error'=>'Token expired, Enter your username again!']);
   // NEW
   return back()->withErrors(['error'=>'Token expired, Enter your username again!']);        
}
