...
Route::group(['prefix'=>'/office','middleware'=>['auth']], function(){
    ...
    // SECTION SMTP Routes
    Route::get('/smtp', [SMTPController::class, 'index'])->middleware(['can:view-office', 'password.confirm']);
    Route::post('/smtp/store', [SMTPController::class, 'store'])->middleware('can:create-office');
    Route::post('/smtp/cron_status', [SMTPController::class, 'setCronStatus'])->middleware('can:create-office');
    Route::put('/smtp/{smtp}', [SMTPController::class, 'update'])->middleware('can:update-office');
    Route::delete('/smtp/destroy/{smtp}', [SMTPController::class, 'destroy'])->middleware('can:delete-office');
    // !SECTION SMTP Routes
